...
def inspect_database():
    ...
    # Specifically check coa_master_timetable
    coa_tables = [t for t in tables if 'coa' in t['table_name'].lower() or 'timetable' in t['table_name'].lower()]
    print(f"\nCOA / Timetable Candidate Tables: {[t['table_name'] for t in coa_tables]}")
